...
import "./about.css";
import AboutImg from "../../assets/Me/guts.JPG";
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            Je suis Idrissi Jazouli Mehdi, étudiant en Data Science. Passionné
            par l'analyse de données et le machine learning, je me spécialise
            dans l'utilisation d'algorithmes pour résoudre des problèmes
            complexes. Mon expérience couvre l'exploration de données, la
